...
用到的技术：[approximated ACES tone-mapping](https://zhuanlan.zhihu.com/p/21983679)，[PrefilteredDFG_Karis函数](https://www.unrealengine.com/zh-CN/blog/physically-based-shading-on-mobile)，[伽马校正](https://learnopengl-cn.readthedocs.io/zh/latest/05%20Advanced%20Lighting/02%20Gamma%20Correction/)
...
vec3 render(in vec3 origin, in vec3 direction, out float distance) {
    ...
    if (material > 0.0) {
        ...
        //https://zhuanlan.zhihu.com/p/53086060里面的6.3.1 流派1：2D LUT
